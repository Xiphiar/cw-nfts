...
pub type Cw2981Contract<'a> = Cw721Contract<'a, Extension, Empty, ExtendedExecuteMsg, Cw2981QueryMsg>;
pub type ExecuteMsg = cw721_base::ExecuteMsg<Extension, ExtendedExecuteMsg>;
pub type QueryMsg = cw721_base::QueryMsg<Cw2981QueryMsg>;

#[cfg(not(feature = "library"))]
pub mod entry {
    use crate::execute::batch_mint;
    use crate::msg::ExtendedExecuteMsg;
    ...
    pub fn execute(
        ...
        match msg {
            ExecuteMsg::Extension { msg } => match msg {
                ExtendedExecuteMsg::BatchMint {
                    tokens
                } => batch_mint(deps, info, tokens)
            },
            _ => Cw2981Contract::default().execute(deps, env, info, msg).map_err(Into::into),
        }
    }
